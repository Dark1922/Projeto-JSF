...
public class DaoGeneric<E> { //E de entidade pode ser qlq outra letra
	...
	public void deletePorId(E entidade) { //método de salvar
		...
		//usa o getClass.GetName do java vai passar o nome da nossa tabela Pessoa massa  e o id identificado e deletar ele
		entityManager.createQuery("delete from " + entidade.getClass().getName() + " where id = " + id).executeUpdate(); //update serve pra delete tb;
	...
	public List<E> getListEntity(Class<E> entidade) {
		...
		//por debaixo dos pano vai fazer um from * select Pessoa pq vai passar a pessoa dentro do entidadae (class<E> entidade)
